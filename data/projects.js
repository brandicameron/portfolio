export const projects = [
    ...
    links: [
      {
        ...
        ariaLabel: 'View this project View Live, opens in a new window.',
  ...
  },
  {
    ...
    description: ['Full featured "Netflix style" recipe app.'],
    descriptionList: [
      ...
      'Type amounts naturally (e.g. 1/2 tsp vanilla) — the app takes care of the decimal conversion under the hood for servings recalculations.',
